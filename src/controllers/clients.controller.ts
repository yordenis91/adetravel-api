...
export async function updateClient(req: Request, res: Response): Promise<void> {
  const item = await prisma.client.update({ where: { id: req.params.id }, data: req.body as object });
...
export async function deleteClient(req: Request, res: Response): Promise<void> {
  const item = await prisma.client.update({ where: { id: req.params.id }, data: { isActive: false } });
